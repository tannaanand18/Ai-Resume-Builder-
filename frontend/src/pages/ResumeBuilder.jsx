        ...
        <div className="rb-navbar-right" style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          <div style={{ position: "relative" }}>
            <button onClick={() => setShowShare(!showShare)}
              ...
              <span className="rb-btn-text">Share</span>
            </button>
          ...
          <button onClick={async () => { showToast("📄 Preparing PDF..."); await handlePrint(); }}
            ...
            <span className="rb-btn-text">Download PDF</span>
          </button>
...
try {
  ...
  <textarea className="rb-inp" style={{ ...inp, resize: "none" }} rows={3}
    ...
    onChange={e => setProjForm({ ...projForm, description: e.target.value })} />
        ...
        {/* RIGHT — Live Preview */}
        <div className={mobileView === "edit" ? "rb-panel-hidden" : "rb-panel-right"} style={{ overflowY: "auto", background: "linear-gradient(180deg, #e2e8f0 0%, #cbd5e1 100%)", padding: "24px 0", display: "flex", justifyContent: "center" }}>
