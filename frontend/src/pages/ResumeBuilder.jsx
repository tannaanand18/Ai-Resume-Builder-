    ...
    <div style={{ fontFamily: "Georgia, serif", fontSize: 11, color: "#111", lineHeight: 1.6, padding: "32px 36px", background: "#fff", minHeight: "100%" }}>
      <div style={{ textAlign: "center", borderBottom: "2px solid #111", paddingBottom: 12, marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 16, fontSize: 10, color: "#555" }}>
          {email && <a href={`mailto:${email}`} target="_blank" style={{color:"inherit",textDecoration:"none"}}>✉ {email}</a>}{phone && <a href={`tel:${phone?.replace(/\s+/g,"")}`} target="_blank" style={{color:"inherit",textDecoration:"none"}}>📱 {phone}</a>}{location && <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(location)}`} target="_blank" rel="noopener noreferrer" style={{color:"inherit",textDecoration:"none"}}>📍 {location}</a>}{linkedin && <a href={linkedin.startsWith("http")?linkedin:`https://${linkedin}`} target="_blank" rel="noopener noreferrer" style={{color:"inherit",textDecoration:"none"}}>🔗 {linkedin}</a>}
        </div>
      </div>
      ...
      <div style={{ width: 180, background: accent, padding: "24px 16px", color: "#fff", flexShrink: 0 }}>
        ...
        <div style={{ pageBreakInside: "avoid", breakInside: "avoid", marginBottom: 16 }}>
          <SideSection title="Contact" color="#fff">
            {email && <a href={`mailto:${email}`} target="_blank" style={{color:"inherit",textDecoration:"none",fontSize:8.5,opacity:0.8,marginBottom:3,display:"block"}}>✉ {email}</a>}
            {phone && <a href={`tel:${phone?.replace(/\s+/g,"")}`} target="_blank" style={{color:"inherit",textDecoration:"none",fontSize:8.5,opacity:0.8,marginBottom:3,display:"block"}}>📱 {phone}</a>}
            {location && <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(location)}`} target="_blank" rel="noopener noreferrer" style={{color:"inherit",textDecoration:"none",fontSize:8.5,opacity:0.8,marginBottom:3,display:"block"}}>📍 {location}</a>}
            {linkedin && <a href={linkedin.startsWith("http")?linkedin:`https://${linkedin}`} target="_blank" rel="noopener noreferrer" style={{color:"inherit",textDecoration:"none",fontSize:8.5,opacity:0.8,marginBottom:3,display:"block"}}>🔗 {linkedin}</a>}
          </SideSection>
        </div>
    ...
    <div style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 11, color: "#222", lineHeight: 1.45, padding: "24px 40px", background: "#fff", minHeight: "100%", boxSizing: "border-box" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px 18px", fontSize: 11, color: "#111", fontWeight: 600 }}>
          {location && <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(location)}`} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:4,color:"inherit",textDecoration:"none"}}>📍 {location}</a>}
          {email && <a href={`mailto:${email}`} target="_blank" style={{display:"flex",alignItems:"center",gap:4,color:"inherit",textDecoration:"none"}}>✉ {email}</a>}
          {phone && <a href={`tel:${phone?.replace(/\s+/g,"")}`} target="_blank" style={{display:"flex",alignItems:"center",gap:4,color:"inherit",textDecoration:"none"}}>📞 {phone}</a>}
          {linkedin && <a href={linkedin.startsWith("http")?linkedin:`https://${linkedin}`} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:4,color:"inherit",textDecoration:"none"}}>in {linkedin}</a>}
        </div>
      </div>
          ...
          {projects.map((p, i) => (
            <div key={i} style={{ marginBottom: 10, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                ...
                {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 11, color: "#111" }}>View Link</a>}
              </div>
            ...
            {projects.map((p, i) => (
              <div key={`p${i}`} style={{ pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  ...
                  {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10, color: "#000", fontWeight: 700 }}>View Link</a>}
                </div>
    ...
    <div style={{ fontFamily: "Arial, Helvetica, sans-serif", fontSize: 10.5, color: "#222", lineHeight: 1.4, padding: "20px 36px", background: "#fff", minHeight: "100%", boxSizing: "border-box" }}>
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "12px 16px", fontSize: 10.5, color: "#555", marginTop: 6 }}>
          {email && <a href={`mailto:${email}`} target="_blank" style={{display:"flex",alignItems:"center",color:"inherit",textDecoration:"none"}}><span style={{color:iconBlue,marginRight:4,fontSize:13}}>✉</span>{email}</a>}
          {phone && <a href={`tel:${phone?.replace(/\s+/g,"")}`} target="_blank" style={{display:"flex",alignItems:"center",color:"inherit",textDecoration:"none"}}><span style={{color:iconBlue,marginRight:4,fontSize:13}}>📞</span>{phone}</a>}
          {location && <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(location)}`} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",color:"inherit",textDecoration:"none"}}><span style={{color:iconBlue,marginRight:4,fontSize:13}}>📍</span>{location}</a>}
          {linkedin && <a href={linkedin.startsWith("http")?linkedin:`https://${linkedin}`} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",color:"inherit",textDecoration:"none"}}><span style={{color:iconBlue,marginRight:4,fontSize:13}}>in</span>{linkedin}</a>}
        </div>
      </div>
          ...
          {projects.map((p, i) => (
            <div key={i} style={{ marginBottom: 10, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                ...
                {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10.5, color: iconBlue, textDecoration: "none", fontWeight: 700 }}>View Link</a>}
              </div>
      ...
      <div style={{ width: "35%", background: hunter, padding: "24px 24px", color: "#fff", flexShrink: 0 }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, fontSize: 10.5, color: "#cbd5e1" }}>
            {email && <a href={`mailto:${email}`} target="_blank" style={{display:"flex",alignItems:"center",gap:6,color:"inherit",textDecoration:"none"}}><span>✉</span> {email}</a>}
            {phone && <a href={`tel:${phone?.replace(/\s+/g,"")}`} target="_blank" style={{display:"flex",alignItems:"center",gap:6,color:"inherit",textDecoration:"none"}}><span>📞</span> {phone}</a>}
            {location && <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(location)}`} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"flex-start",gap:6,color:"inherit",textDecoration:"none"}}><span>📍</span> <span>{location}</span></a>}
            {linkedin && <a href={linkedin.startsWith("http")?linkedin:`https://${linkedin}`} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:6,color:"inherit",textDecoration:"none"}}><span>🔗</span> {linkedin}</a>}
          </div>
        </div>
            ...
            {projects.map((p, i) => (
              <div key={i} style={{ marginBottom: 12, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  ...
                  {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10, color: hunter, fontWeight: 700, textDecoration: "none" }}>View Link</a>}
                </div>
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", fontSize: 10.5, color: "#111", fontWeight: 600 }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
            {location && <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(location)}`} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:6,color:"inherit",textDecoration:"none"}}>📍 {location}</a>}
            {phone && <a href={`tel:${phone?.replace(/\s+/g,"")}`} target="_blank" style={{display:"flex",alignItems:"center",gap:6,color:"inherit",textDecoration:"none"}}>📞 {phone}</a>}
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 3, textAlign: "right", alignItems: "flex-end" }}>
            {email && <a href={`mailto:${email}`} target="_blank" style={{display:"flex",alignItems:"center",gap:6,color:"inherit",textDecoration:"none"}}>✉ {email}</a>}
            {linkedin && <a href={linkedin.startsWith("http")?linkedin:`https://${linkedin}`} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:6,color:"inherit",textDecoration:"none"}}>🔗 {linkedin}</a>}
          </div>
        </div>
      </div>
          ...
          {projects.map((p, i) => (
            <div key={i} style={{ marginBottom: 10, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                ...
                {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10, color: "#111", fontWeight: 700 }}>View Link</a>}
              </div>
              ...
              {projects.map((p, i) => (
                <div key={i} style={{ marginBottom: 12, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                    ...
                    {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10, color: navy, fontWeight: 700, textDecoration: "none" }}>Link</a>}
                  </div>
          ...
          {projects.map((p, i) => (
            <div key={i} style={{ marginBottom: 12 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                ...
                {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 11, color: "#000" }}>View Project</a>}
              </div>
              ...
              {projects.map((p, i) => (
                <div key={i} style={{ marginBottom: 10, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                    ...
                    {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10, color: purple, fontWeight: 700, textDecoration: "none" }}>View Link</a>}
                  </div>
            ...
            {projects.map((p, i) => (
              <div key={i} style={{ marginBottom: 8, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  ...
                  {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10.5, color: "#111" }}>View Project</a>}
                </div>
            ...
            {projects.map((p, i) => (
              <div key={i} style={{ marginBottom: 12, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  ...
                  {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10.5, color: coral, fontWeight: 700, textDecoration: "none" }}>View Link</a>}
                </div>
          ...
          <AccentSection title="Projects" icon="🚀">
            {projects.map((p, i) => (
              <div key={i} style={{ marginBottom: 10, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  <span style={{ fontWeight: 800, fontSize: 11.5, color: "#111" }}>{p.title}</span>
                  {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10, color: accent, fontWeight: 700, textDecoration: "none" }}>View Link</a>}
                </div>
    ...
    <div style={{ display: "flex", marginBottom: 10, gap: 16, pageBreakInside: "avoid", breakInside: "avoid", width: "100%" }}>
      ...
      <div style={{ flex: 1 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
          ...
          {link ? (
            <a href={link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10.5, color: teal, fontWeight: 700, textDecoration: "none" }}>View Link</a>
          ) : locationText && (
          ...
          {projects.map((p, i) => (
            <div key={i} style={{ marginBottom: 10, pageBreakInside: "avoid", breakInside: "avoid", display: "inline-block", width: "100%" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                ...
                {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10.5, color: blue, fontWeight: 700 }}>View Link</a>}
              </div>
              {p.tech_stack && <div style={{ fontSize: 10.5, color: "#555", fontStyle: "italic", marginBottom: 2 }}>{p.tech_stack}</div>}
              {p.description && <div style={{ color: "#333", lineHeight: 1.4, marginTop: 2 }}>• {p.description}</div>}
            </div>
  ...
  return (
    <div style={{ marginBottom: 8, pageBreakInside: "avoid", breakInside: "avoid" }}>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        {p.link && <a href={p.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 10, color: "#2563eb" }}>Link</a>}
      </div>
